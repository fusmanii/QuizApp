(function() {
  ...
  // var deerAnswers = [2, 1, 2];
  // var  deerQuestions =  [ {
  //           type: "text",
  //           text: "How much can a reindeer?",
  //           possibilities: [
  //               {
  //                   answer: "Up to 20kg"
  //               },
  ...
  //       {
  //           type: "text",
  //           text: "What is the typical lifespan of a moose?",
  //           possibilities: [
  //               {
  //                   answer: "110 - 150 years"
  //               },
  //               {
  //                   answer: "15 – 25 years"
  //               },
  ...
  //       {
  //           type: "image",
  //           text: "Which of these is the Elk?",
  //           possibilities: [
  //               {
  //                   answer: "http://images.mentalfloss.com/sites/default/files/styles/article_640x430/public/reindeer.jpg"
  //               },
  //               {
  //                   answer: "http://www.cbc.ca/natureofthings/content/images/episodes/moose_infographic.jpg"
  //               },
  //               {
  //                   answer: "http://www.astronomy-images.com/day-images/California/tuleelk.bull.modcrop.2725.jpg"
  //               },
  //               {
  //                   answer: "http://www.woburnabbey.co.uk/media/320657/red-deer-woburn-abbey-01525290333-copyright-remains-with-his-grace-the-duke-of-bedford-and-the-trustees-of-the-bedford-estates_16-9.jpg"
  //               }
  //           ],
  //           selected: null,
  //           correct: null
  ...
  // db.animals.update({type: },{imageUrl: })


  // var turtlesData = [
  //         {
  //             type: "Green Turtle",
  //             image_url: "https://conserveturtles.org/wp-content/uploads/green-adult-DavidSchrichte.jpg",
